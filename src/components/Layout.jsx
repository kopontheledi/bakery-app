    ...
    <>
      <header className="nav">
        ...
        <div className="nav-actions">
          <a className="icon-btn" href={`tel:${BUSINESS.phoneDisplay}`} aria-label="Call">
            <Phone size={18} />
          </a>
      ...
      <footer>
        ...
        <div>
          ...
          <a href={`tel:${BUSINESS.phoneDisplay}`}>{BUSINESS.phoneDisplay}</a>
        </div>

        <small className="copyright">© {new Date().getFullYear()} MJ Bakery Delights</small>
      </footer>
    </>
  );
}
